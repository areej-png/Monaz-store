...
export default function NightSuitBlogDetail({ post, onBack }) {
  if (post.slug === "night-suit-season-guide")
    return <NightSuitSeasonDetail post={post} onBack={onBack} />;
  if (post.slug === "night-suit-fabric-guide")
    return <NightSuitFabricDetail post={post} onBack={onBack} />;
  if (post.slug === "night-suit-style-guide")
    return <NightSuitStyleDetail post={post} onBack={onBack} />;
